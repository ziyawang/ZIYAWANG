...
function showAreaID() {
    ...
    // var areaName1 = getAreaNamebyID(areaID1) ;
...
// v2 == end 
    $(function(){
        ...
        // v2=====start ie support placeholder
        if(!placeholderSupport()){   // ie placeholder
