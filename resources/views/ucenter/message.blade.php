...
$(function(){
    ...
    // token = "eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiIxIiwiaXNzIjoiaHR0cDpcL1wvYXBpdGVzdC56aXlhd2FuZy5jb21cL3YxXC9hdXRoXC9sb2dpbiIsImlhdCI6IjE0NzQ4OTQ3MzYiLCJleHAiOiIxNDc1NDk5NTM2IiwibmJmIjoiMTQ3NDg5NDczNiIsImp0aSI6ImQ2MGJkMmRjY2UxYWIyYTZmZmMxMjllZGI1ZGFlMGVlIn0.cVvgdg_iHlmIxRp4C3VTt5Dbw-tvJSLaEKUMAKpptMY";
        ...
        $.ajax({  
            url: 'http://apis.ziyawang.com/zll/getmessage?pagecount=6&startpage=1&access_token=token&token=' + token,  
            type: 'POST',  
            dataType: 'json',  
            timeout: 5000,  
            cache: false,  
        ...
        function succFunction(tt) {
            ...
            $(".line_info").not(".msgbox").click(function() {
                ...
                $.ajax({
                    url: 'http://apis.ziyawang.com/zll/readmessage?access_token=token&token=' + token,
                    type: 'POST',
                    data: {'TextID':TextID},
                    dataType: 'json',
...
function ajax(){
    ...
    $.ajax({  
        url: 'http://apis.ziyawang.com/zll/getmessage?pagecount=6&access_token=token&token=' + token + data,  
        type: 'POST',  
        dataType: 'json',  
        timeout: 5000,  
        cache: false,  
...
$('#delete').click(function(){
    ...
    for (var i = check.length - 1; i >= 0; i--) {
     ...
     $.ajax({
        url: 'http://apis.ziyawang.com/zll/delmessage?access_token=token&token=' + token,
        type: 'POST',
        data: {'TextID':TextID},
        dataType: 'json',
        success: function(msg){
