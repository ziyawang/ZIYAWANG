...
<!-- 头像上传 -->
            ...
            <div class="up_ceti clearfix">
                ...
                <span style="color:#999;margin-left:-140px;">注：图片大小请小于2M</span>
...
<script>
    $(function(){
        ...
        if(role.indexOf('2') > 0) {
            ...
            $('#pub').hide();
            $(".mr_perfect").append("<a id='repub' href='http://ziyawang.com/ucenter/reconfirm'>重新提交资料</a>")
        }
        ...
        if(role.indexOf('1') > 0 || role.indexOf('2') > 0 ){
            $.ajax({
