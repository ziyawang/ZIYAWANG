    ...
    $.ajax({  
        ...
        function succFunction(tt) {  
         $("#spec01").html('');
            ...
            if(CertifyState == '0'){
                PublishState = "<a href='http://test.ziyawang.com/ucenter/mypro/rushlist/" + ProjectID + "' class='much applyorder'>审核中</a>";
            } else if ( CertifyState == '1') {
                PublishState = "<a href='http://test.ziyawang.com/ucenter/mypro/rushlist/" + ProjectID + "' class='much applyorder' id=rush>查看抢单人</a>";
