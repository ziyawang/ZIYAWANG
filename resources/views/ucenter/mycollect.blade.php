 ...
 //默认1：项目，2：视频，3：新闻资讯，4：服务方
            ...
            $.each(data, function (index, item) {
                ...
                switch(TypeID)
                {
                    ...
                    case 3:
                        html = html + "<li class='videos'><a href='http://ziyawang.com/news/" + ItemID + "' class='head_pic'><img src='http://images.ziyawang.com" + NewsLogo + "' alt='' /></a><div class='company_info company_name'><a href='http://ziyawang.com/news/" + ItemID + "' class='blue_color'>" + NewsTitle + "</a><p class='collectnews'>" + Brief.substr(0,30) + "</p></div><div class='orders'><span>" + CollectTime + "</span><a href='javascript:;' clear='collect' id='" + ItemID + "' type='3'>删除</a></div></li>";
                        break;

                    case 4:
                        html = html + "<li><a href='http://ziyawang.com/service/" + ItemID + "' class='head_pic'><img src='http://images.ziyawang.com" + UserPicture + "' alt='' /></a><div class='company_info'><a href='http://ziyawang.com/service/" + ItemID + "' class='blue_color'>" + ServiceName + "</a><p class='change_info'><span>服务地区：" + ServiceArea + "</span><span class='changed_con'>服务类型：" + ServiceType + "</span></p></div><div class='orders'><span>" + CollectTime + "</span><a href='javascript:;' clear='collect' id='" + ItemID + "' type='4'>删除</a></div></li>";
                        break;
                }
