                    ...
                    ProType = ProType + '';
                        switch(ProType)
                        {
                            ...
                            case "6":
                                ...
                                break;
                            case "12":
                                html = html + "<li class='clearfix'><a href='http://ziyawang.com/project/" + ProType + "/" + ItemID + "'>" + cooperate + "<div class='pblLeft'><span class='pblef2'></span>" + TypeName + "</div><div class='pblMiddle'><span class='spanTagDet'>" + Title + "</span><span class='spanTag'>标的物类型：<strong>" + AssetType + "</strong></span><span>地区：<strong>" + ProArea + "</strong></span></div><div class='pblBtn'><span class='verticaLine'></span><div class='pblRight'><span></span><span><strong>转让价：</strong>" + TransferMoney + "万元</span><span></span></div></div></a><span class='delete' title='取消收藏' onclick='cancel(this)' class='collect' id='" + ItemID + "' type='1'></span><span class='uniqueTime'>" + CollectTime + "</span></li>";
                                break;
                            ...
                            case "20":
                                html = html + "<li class='clearfix'><a href='http://ziyawang.com/project/" + ProType + "/" + ItemID + "'>" + cooperate + "<div class='pblLeft'><span class='pblef6'></span>" + TypeName + "</div><div class='pblMiddle'><span class='spanTagDet'>" + Title + "</span><span class='spanTag'>资产类型：<strong>" + AssetType + "</strong></span><span>地区：<strong>" + ProArea + "</strong></span><span>面积：<strong>" + Area + "平米</strong></span></div><div class='pblBtn'><span class='verticaLine'></span><div class='pblRight'><span></span><span><strong>起拍价：</strong>" + Money + "万元</span><span></span></div></div></a><span class='delete' title='取消收藏' onclick='cancel(this)' class='collect' id='" + ItemID + "' type='1'></span><span class='uniqueTime'>" + CollectTime + "</span></li>";
                                break;
