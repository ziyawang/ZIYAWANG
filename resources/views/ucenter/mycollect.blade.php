                ...
                switch(TypeID)
                {
                    case 1:
                        switch(Type)
                        {
                            ...
                            case "10":
                                html = html + "<li class='clearfix black'><a href='javascript:;'><div class='pblLeft'><span class='pblef10'></span>" + ProjectNumber + "</div><div class='pblMiddle'><span class='spanTagDet'>详情：" + WordDes + "</span></div><div class='pblBtn'><span class='verticaLine'></span><div class='pblRight'><span><strong>地区：</strong>" + ProArea + "</span><span><strong>类型：</strong>" + AssetType + "</span><span><strong>被调查方：</strong>" + Informant + "</span></div></div></a><span class='delete' title='取消收藏' onclick='cancel(this)' class='collect' id='" + ItemID + "' type='1'></span></li>";
                                break;

                            case "12":
                                html = html + "<li class='clearfix'><a href='javascript:;'><div class='pblLeft'><span class='pblef12'></span>" + ProjectNumber + "</div><div class='pblMiddle'><span>标的物：<strong>" + Corpore + "万</strong></span><span>地区：<strong>" + ProArea + "万</strong></span><span class='spanTag'>类型：<strong>" + AssetType + "</strong></span><span class='spanTagDet'>详情：" + WordDes + "</span></div><div class='pblBtn'><span class='verticaLine'></span><div class='pblRight'><span><strong>总金额：</strong>" + TotalMoney + "万</span><span></span><span><strong>转让价：</strong>" + TransferMoney + "万</span></div></div></a><span class='delete' title='取消收藏' onclick='cancel(this)' class='collect' id='" + ItemID + "' type='1'></span></li>";
                                break;

                            case "13":
                                html = html + "<li class='clearfix black'><a href='javascript:;'><div class='pblLeft'><span class='pblef13'></span>" + ProjectNumber + "</div><div class='pblMiddle'><span class='spanTagDet'>详情：" + WordDes + "</span></div><div class='pblBtn'><span class='verticaLine'></span><div class='pblRight'><span><strong>地区：</strong>" + ProArea + "</span><span class='spanTag'><strong>类型：</strong>" + AssetType + "</span><span><strong>求购方：</strong>" + Buyer + "</span></div></div></a><span class='delete' title='取消收藏' onclick='cancel(this)' class='collect' id='" + ItemID + "' type='1'></span></li>";
                                break;

                            case "14":
                                html = html + "<li class='clearfix'><a href='javascript:;'><div class='pblLeft'><span class='pblef14'></span>" + ProjectNumber + "</div><div class='pblMiddle'><span>地区：<strong>" + ProArea + "</strong></span><span>类型：<strong>" + AssetType + "</strong></span><span class='spanTag'></span><span class='spanTagDet'>详情：" + WordDes + "</span></div><div class='pblBtn'><span class='verticaLine'></span><div class='pblRight'><span><strong>总金额：</strong>" + TotalMoney + "万</span><span></span><span><strong>转让价：</strong>3000.00万</span></div></div></a><span class='delete' title='取消收藏' onclick='cancel(this)' class='collect' id='" + ItemID + "' type='1'></span></li> ";
                                break;

                            case "15":
                                html = html + "<li class='clearfix'><a href='javascript:;'><div class='pblLeft'><span class='pblef15'></span>" + ProjectNumber + "</div><div class='pblMiddle'><span>地区：<strong>" + ProArea + "</strong></span><span>投资类型：<strong>" + AssetType + "</strong></span><span class='spanTag'>投资方式：<strong>" + InvestType + "</strong></span><span class='spanTagDet'>详情：" + WordDes + "</span></div><div class='pblBtn'><span class='verticaLine'></span><div class='pblRight'><span><strong>预期回报率：</strong>" + Rate + "%</span><span></span><span><strong>投资期限：</strong>" + Year + "年</span></div></div></a><span class='delete' title='取消收藏' onclick='cancel(this)' class='collect' id='" + ItemID + "' type='1'></span></li>";
                                break;
                        }
                        break;

                    case 2:
                        html = html + "<li class='clearfix'><a href='http://ziyawang.com/video/" + ItemID + "'><div class='pblLeft colVideo'><span class='pblefNewsImg'><img src='http://images.ziyawang.com" + VideoLogo + "' /></span></div><div class='pblMiddle colVideoInfo'><h4>" + VideoTitle + "</h4><em>已播放" + ViewCount + "次</em><p>" + VideoDes + "</p></div></a><span class='delete' title='取消收藏' onclick='cancel(this)' class='collect' id='" + ItemID + "' type='2'></span></li>";
                        break;

                    case 3:
                        html = html + "<li class='clearfix'><a href='http://ziyawang.com/news/" + ItemID + "'><div class='pblLeft colNews'><span class='pblefNewsImg'><img src='http://images.ziyawang.com" + NewsLogo + "' /></span></div><div class='pblMiddle colNewsInfo'><h4>" + NewsTitle + "<span>" + CollectTime + "</span></h4><p>" + Brief + "</p></div></a><span class='delete' title='取消收藏' onclick='cancel(this)' class='collect' id='" + ItemID + "' type='3'></span></li>";
                        break;

                    case 4:
                        html = html + "<li class='clearfix black'><a href='http://ziyawang.com/service/" + ItemID + "'><div class='pblLeft'><span class='pblefImg'><img src='http://images.ziyawang.com" + UserPicture + "' /></span>" + ServiceNumber + "</div><div class='pblMiddle servicer'><h4>" + ServiceName + "</h4><p>" + ServiceType + "</p></div><div class='pblBtn'><span class='verticaLine'></span><div class='pblRight serveZone'><span><strong>服务地区：</strong>" + ServiceArea + "</span><span></span><span><strong>所在地：</strong>" + ServiceLocation + "</span></div></div></a><span class='delete' title='取消收藏' onclick='cancel(this)' class='collect' id='" + ItemID + "' type='4'></span></li>";
                        break;
                }
