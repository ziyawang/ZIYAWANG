        ...
        function succFunction(tt) {  
            ...
            $.each(data, function (index, item) {
                ...
                if(CertifyState == '0'){
                    ...
                    if(PublishState == '0'){
                        PublishState = "<a href='http://test.ziyawang.com/project/"+ ProjectID +"' class='cancel'>抢单中</a>";
                    } else if ( PublishState == '1') {
                        PublishState = "<a href='http://test.ziyawang.com/project/"+ ProjectID +"' class='cancel'>已合作</a>";
                    } else if ( PublishState == '2') {
                        PublishState = "<a href='http://test.ziyawang.com/project/"+ ProjectID +"' class='cancel'>订单取消中</a>"; 
                    }
                }
                ...
                {
                    case "1":
                        var html = "<li><h3>资产包转让</h3><div class='myorder'><span class='myorder_icon'><img src='/img/img088.png' /></span><a href='http://test.ziyawang.com/ucenter/mypro/"+ ProjectID +"' class='myorder_abstr'><span>编号：" + ProjectNumber + "</span><span>总金额：" + TotalMoney + "万</span><span>资产包类型：" + AssetType + "</span><span>地区：" + ProArea + "</span><span>转让价：" + TransferMoney + "万</span><span>来源：" + FromWhere + "</span></a><div class='myorder_info'><span class='ed'><em class='blue'>" + RushCount + "人</em>已抢单</span><span class='many'>浏览数：<i>" + ViewCount + "</i>人</span></div></div><p class='time'>" + PublishTime + "</p>" + PublishState + "</li>";
                        break;
                    case "2":
                        var html = "<li><h3>委外催收</h3><div class='myorder'><span class='myorder_icon'><img src='/img/img088.png' /></span><a href='http://test.ziyawang.com/ucenter/mypro/"+ ProjectID +"' class='myorder_abstr'><span>编号：" + ProjectNumber + "</span><span>债权人所在地：" + ProArea + "</span><span>金额：" + TotalMoney + "万</span><span>状态：" + Status + "</span><span>佣金比例：" + Rate + "</span><span>类型：" + AssetType + "</span></a><div class='myorder_info'><span class='ed'><em class='blue'>" + RushCount + "人</em>已抢单</span><span class='many'>浏览数：<i>" + ViewCount + "</i>人</span></div></div><p class='time'>" + PublishTime + "</p>" + PublishState + "</li>";
                        break;
                    case "3":
                        var html = "<li><h3>法律服务</h3><div class='myorder'><span class='myorder_icon'><img src='/img/img088.png' /></span><a href='http://test.ziyawang.com/ucenter/mypro/"+ ProjectID +"' class='myorder_abstr'><span>编号：" + ProjectNumber + "</span><span>类型：" + AssetType + "</span><span>需求：" + Requirement + "</span></a><div class='myorder_info'><span class='ed'><em class='blue'>" + RushCount + "人</em>已抢单</span><span class='many'>浏览数：<i>" + ViewCount + "</i>人</span></div></div><p class='time'>" + PublishTime + "</p>" + PublishState + "</li>";
                        break;

                    case "4":
                        var html = "<li><h3>商业保理</h3><div class='myorder'><span class='myorder_icon'><img src='/img/img088.png' /></span><a href='http://test.ziyawang.com/ucenter/mypro/"+ ProjectID +"' class='myorder_abstr'><span>编号：" + ProjectNumber + "</span><span>合同金额：" + TotalMoney + "万</span><span>地区：" + ProArea + "</span><span>买方性质：" + BuyerNature + "</span></a><div class='myorder_info'><span class='ed'><em class='blue'>" + RushCount + "人</em>已抢单</span><span class='many'>浏览数：<i>" + ViewCount + "</i>人</span></div></div><p class='time'>" + PublishTime + "</p>" + PublishState + "</li>";
                        break;

                    case "5":
                        var html = "<li><h3>典当担保</h3><div class='myorder'><span class='myorder_icon'><img src='/img/img088.png' /></span><a href='http://test.ziyawang.com/ucenter/mypro/"+ ProjectID +"' class='myorder_abstr'><span>编号：" + ProjectNumber + "</span><span>类型：" + AssetType + "</span><span>地区：" + ProArea + "</span><span>金额：" + TotalMoney + "万</span></a><div class='myorder_info'><span class='ed'><em class='blue'>" + RushCount + "人</em>已抢单</span><span class='many'>浏览数：<i>" + ViewCount + "</i>人</span></div></div><p class='time'>" + PublishTime + "</p>" + PublishState + "</li>";
                        break;

                    case "6":
                        var html = "<li><h3>融资借贷</h3><div class='myorder'><span class='myorder_icon'><img src='/img/img088.png' /></span><a href='http://test.ziyawang.com/ucenter/mypro/"+ ProjectID +"' class='myorder_abstr'><span>编号：" + ProjectNumber + "</span><span>方式：" + AssetType + "</span><span>地区：" + ProArea + "</span><span>金额：" + TotalMoney + "万</span><span>回报率：" + Rate + "%</span></a><div class='myorder_info'><span class='ed'><em class='blue'>" + RushCount + "人</em>已抢单</span><span class='many'>浏览数：<i>" + ViewCount + "</i>人</span></div></div><p class='time'>" + PublishTime + "</p>" + PublishState + "</li>";
                        break;

                    case "9":
                        var html = "<li><h3>悬赏信息</h3><div class='myorder'><span class='myorder_icon'><img src='/img/img088.png' /></span><a href='http://test.ziyawang.com/ucenter/mypro/"+ ProjectID +"' class='myorder_abstr'><span>编号：" + ProjectNumber + "</span><span>类型：" + AssetType + "</span><span>目标地区：" + ProArea + "</span><span>金额：" + TotalMoney + "万</span></a><div class='myorder_info'><span class='ed'><em class='blue'>" + RushCount + "人</em>已抢单</span><span class='many'>浏览数：<i>" + ViewCount + "</i>人</span></div></div><p class='time'>" + PublishTime + "</p>" + PublishState + "</li>";
                        break;

                    case "10":
                        var html = "<li><h3>尽职调查</h3><div class='myorder'><span class='myorder_icon'><img src='/img/img088.png' /></span><a href='http://test.ziyawang.com/ucenter/mypro/"+ ProjectID +"' class='myorder_abstr'><span>编号：" + ProjectNumber + "</span><span>类型：" + AssetType + "</span><span>地区：" + ProArea + "</span><span>被调查方：" + Informant + "</span></a><div class='myorder_info'><span class='ed'><em class='blue'>" + RushCount + "人</em>已抢单</span><span class='many'>浏览数：<i>" + ViewCount + "</i>人</span></div></div><p class='time'>" + PublishTime + "</p>" + PublishState + "</li>";
                        break;

                    case "12":
                        var html = "<li><h3>固产转让</h3><div class='myorder'><span class='myorder_icon'><img src='/img/img088.png' /></span><a href='http://test.ziyawang.com/ucenter/mypro/"+ ProjectID +"' class='myorder_abstr'><span>编号：" + ProjectNumber + "</span><span>类型：" + AssetType + "</span><span>地区：" + ProArea + "</span><span>转让价：" + TransferMoney + "万</span></a><div class='myorder_info'><span class='ed'><em class='blue'>" + RushCount + "人</em>已抢单</span><span class='many'>浏览数：<i>" + ViewCount + "</i>人</span></div></div><p class='time'>" + PublishTime + "</p>" + PublishState + "</li>";
                        break;

                    case "13":
                        var html = "<li><h3>资产求购</h3><div class='myorder'><span class='myorder_icon'><img src='/img/img088.png' /></span><a href='http://test.ziyawang.com/ucenter/mypro/"+ ProjectID +"' class='myorder_abstr'><span>编号：" + ProjectNumber + "</span><span>类型：" + AssetType + "</span><span>地区：" + ProArea + "</span><span>求购方：" + Buyer + "</span></a><div class='myorder_info'><span class='ed'><em class='blue'>" + RushCount + "人</em>已抢单</span><span class='many'>浏览数：<i>" + ViewCount + "</i>人</span></div></div><p class='time'>" + PublishTime + "</p>" + PublishState + "</li>";
                        break;

                    case "14":
                        var html = "<li><h3>债权转让</h3><div class='myorder'><span class='myorder_icon'><img src='/img/img088.png' /></span><a href='http://test.ziyawang.com/ucenter/mypro/"+ ProjectID +"' class='myorder_abstr'><span>编号：" + ProjectNumber + "</span><span>类型：" + AssetType + "</span><span>地区：" + ProArea + "</span><span>金额：" + TotalMoney + "万</span><span>转让价：" + TransferMoney + "万</span></a><div class='myorder_info'><span class='ed'><em class='blue'>" + RushCount + "人</em>已抢单</span><span class='many'>浏览数：<i>" + ViewCount + "</i>人</span></div></div><p class='time'>" + PublishTime + "</p>" + PublishState + "</li>";
                        break;
                }
