...
<script>
     $(function () {
        ...
        $.ajax({  
            url: 'http://api.ziyawang.com/v1/project/myrush?pagecount=6&startpage=1&access_token=token&token=' + token,  
            type: 'GET',  
            dataType: 'json',  
            timeout: 10000,  
            cache: false,  
        ...
        function succFunction(tt) {  
            ...
            $.each(data, function (index, item) {
                ...
                if(PublishState == '0'){
                    ...
                    PublishState = "<a href='http://test.ziyawang.com/project/"+ ProjectID +"' class='combine'>已合作</a>";
...
function ajax() {
    ...
    $.ajax({              
        url: 'http://api.ziyawang.com/v1/project/myrush?pagecount=6&access_token=token&token=' + token + data,  
        type: 'GET',  
        dataType: 'json',  
        timeout: 1000,  
        cache: false,  
