        ...
        <div class="deser_cover">
            ...
            <div class="cover1">
                ...
                <div class="cover_con">
                    <span>资产包类型：</span>
                    <span class="aa">
                        <a href="javascript:;" unlimit="cleardiy">不限</a><a href="javascript:;" diy="AssetType">抵押</a><a href="javascript:;" diy="AssetType">信用</a><a href="javascript:;" diy="AssetType">综合类</a><a href="javascript:;" diy="AssetType">其他</a>
                    </span>
                </div>
            </div>
            <!-- 债权转让 -->
            <div class="cover1">
                <div class="cover_con">
                    <span>类型：</span>
                    <span class="aa"><a href="javascript:;" unlimit="cleardiy">不限</a><a href="javascript:;" diy="AssetType">个人债权</a><a href="javascript:;" diy="AssetType">企业商帐</a><a href="javascript:;" diy="AssetType">其他</a></span>
                </div>
            </div>
            <!-- 估产转让 -->
            <div class="cover1">
            ...
            <div class="cover1">
                ...
                <div class="cover_con">
                    <span>类型：</span>
                    <span class="aa"><a href="javascript:;" unlimit="cleardiy">不限</a><a href="javascript:;" class='defa01' diy="AssetType">个人</a><a href="javascript:;" class='defa02' diy="AssetType">银行</a><a href="javascript:;" class='defa01' diy="AssetType">企业</a><a href="javascript:;" class='defa01' diy="AssetType">其他</a>
                    </span>
                </div>
                <div class="cover_con">
                    <span>佣金比例：</span>
        ...
        function succFunction(tt) {  
            ...
            $.each(data, function (index, item) {
                ...
                switch(TypeID)
                {
                    ...
                    case "14":
                        var html = "<li><a href='#' class='head_pic'><img src='http://images.ziyawang.com" + PictureDes1 + "' alt='' /></a><div class='company_info'><a href='http://ziyawang.com/project/"+ ProjectID +"' class='blue_color'>债权转让</a><p class='visited'>浏览数：<em class='yellow_color'>" + ViewCount + "</em>人</p></div><div class='findinfo_abstr'><span>编号：" + ProjectNumber + "</span><span>类型：" + AssetType + "</span><span>地区：" + ProArea + "</span><span>金额：" + TotalMoney + "万</span><span>转让价：" + TransferMoney + "万</span></div><div class='orders'><span>" + PublishTime + "</span>" + PublishState + "</div></li>";
                        break;
