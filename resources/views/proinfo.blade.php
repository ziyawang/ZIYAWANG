    ...
    $(function () {
        ...
        function succFunction(tt) {  
         $("#spec01").html('');
             ...
             var CollectCount = json.CollectionCount;
             ...
             $("#info").html("<tr><td>信息类型</td><td>"+ TypeName +"</td><td><button id='rush'>申请抢单</button></td><td><button id='collect'>收藏</button></td></tr><tr><td>浏览数</td><td>"+ ViewCount +"人</td><td>收藏数</td><td>"+ CollectCount +"人</td></tr><tr><td>编号：FB"+ ProjectID +"</td><td>地区："+ ProArea +"</td><td>来源："+ FromWhere +"</td><td>总金额："+ TotalMoney +"万</td><td>转让价："+ TransferMoney +"万</td></tr><tr><td>信息完整度：三颗星</td></tr><tr><td>语音信息："+ VoiceDes +"</td></tr><tr><td>文字信息："+ WordDes +"</td></tr><tr><td>清单下载："+ AssetList +"</td></tr><tr><td>图片信息："+ PictureDes +"</td></tr>");  
