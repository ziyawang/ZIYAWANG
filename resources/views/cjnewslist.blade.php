...
<!-- 左侧 -->
    <div class="news_left1">
        <div class="news_bread"><a href="{{url('/')}}">首页&gt;</a><span>财经资讯</span></div>
...
<!-- 公共分页/end -->
    ...
    <div class="news_right1">
        ...
        <div class="news_com1">
            <h2 class="nrc_title"><a href="{{url('/hynews')}}">资芽新闻</a><span>COMPANY&nbsp;NEWS</span></h2>
...
$(function(){
    ...
    //新闻 4个ajax
    $.ajax({  
        url: 'http://api.ziyawang.com/v1/news/list?pagecount=6&NewsLabel=财经资讯&access_token=token',  
        type: 'GET',  
        dataType: 'json',  
        timeout: 1000,  
        cache: false,  
    ...
    function news(tt) {
        ...
        $.each(data, function (index, item) {
            ...
            html = html + "<li><img src='http://images.ziyawang.com" + NewsLogo + "' class='nlc_img' /><h2 class='nlc_title'><a href='http://test.ziyawang.com/news/" + NewsID + "'>" + NewsTitle + "</a></h2><span class='nlc_time'>发表于：" + PublishTime + "</span><p class='nlc_abstr'>" + NewsBrief.substr(0.100) + "...</p></li>"
        });
        $('#newslist').html(html);
...
function ajax(){
    ...
    $.ajax({
        url: 'http://api.ziyawang.com/v1/news/list?pagecount=6&NewsLabel=财经资讯&access_token=token&' + data,  
        type: 'GET',  
        dataType: 'json',  
        timeout: 1000,  
        cache: false,  
