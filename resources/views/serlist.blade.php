...
<div class="description">
    ...
    <div class="service_type">
        ...
        <a type="01" href="javascript:;">资产包收购</a>
        <a type="02" href="javascript:;">催收机构</a>
        <a type="03" href="javascript:;">律师事务所</a>
        <a type="04" href="javascript:;">保理公司</a>
        <a type="05" href="javascript:;">典当担保</a>
        <a type="06" href="javascript:;">投资贷款</a>
        <a type="10" href="javascript:;">尽职调查</a>
        <a type="12" href="javascript:;">资产收购</a>
        <a type="14" href="javascript:;">债权收购</a>
    </div>
    <div class="area">
        <span>服务地区：</span>
