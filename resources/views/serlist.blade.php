...
<script>
    $(function () {
        $.ajax({  
            url: 'http://api.ziyawang.com/api/service/list?pagecount=6&startpage=1&access_token=token',  
            type: 'GET',  
            dataType: 'json',  
            timeout: 1000,  
            cache: false,  
        ...
        function succFunction(tt) {  
            ...
            function ajax() {
                ...
                $.ajax({  
                    url: 'http://api.ziyawang.com/api/service/list?access_token=token&pagecount=6&' + data,  
                    type: 'GET',  
                    dataType: 'json',  
                    timeout: 1000,  
                    cache: false,  
