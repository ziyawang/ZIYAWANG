...
$(function(){
    ...
    function _queryVideo(data) {
        ...
        $.each(data, function (index, item) {  
            ...
            html = html + "<li><a href='http://test.ziyawang.com/video/" + VideoID + "' class='hover_img'><img src='http://images.ziyawang.com" + VideoLogo + "' /><span class='zhezhao'></span></a><p class='vc_title'><a href='http://test.ziyawang.com/video/" + VideoID + "'>" + VideoTitle + "</a></p><p class='vc_condition'>已播放" + ViewCount + "次</p><a href='http://test.ziyawang.com/video/" + VideoID + "' class='vc_icon'></a></li>";
        });
        return html;
    }
    $.ajax({  
