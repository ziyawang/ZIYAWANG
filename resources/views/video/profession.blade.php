...
<div class="video_tab">
    <div class="wrap video_sel">
        <div class="vs_a">
            ...
            <a href="{{url('/video/profession')}}" class="current">行业说</a>
...
<script>
$(function(){
    document.title = '资芽行业说-资芽视频-不良资产领域第一视频平台';
    ...
    $.ajax({  
        url: 'http://api.ziyawang.com/v1/video/list?pagecount=8&VideoLabel=hys&order=1&access_token=token',  
        type: 'GET',  
        dataType: 'json',  
        timeout: 1000,  
        cache: false,  
    ...
    $.ajax({  
        url: 'http://api.ziyawang.com/v1/video/list?pagecount=8&VideoLabel=hys&weight=1&access_token=token',  
        type: 'GET',  
        dataType: 'json',  
        timeout: 1000,  
        cache: false,  
...
function ajax(){
    ...
    $.ajax({
        url: 'http://api.ziyawang.com/v1/video/list?pagecount=8&VideoLabel=hys&weight=1&access_token=token&' + data,  
        type: 'GET',  
        dataType: 'json',  
        timeout: 1000,  
        cache: false,  
