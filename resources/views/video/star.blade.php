...
<div class="video_tab">
    <div class="wrap video_sel">
        <div class="vs_a">
            ...
            <a href="{{url('/video/star')}}" class="current">大咖秀</a>
...
$(function(){
    ...
    $.ajax({  
        url: 'http://api.ziyawang.com/v1/video/list?pagecount=8&VideoLabel=dkx&access_token=token',  
        type: 'GET',  
        dataType: 'json',  
        timeout: 1000,  
        cache: false,  
