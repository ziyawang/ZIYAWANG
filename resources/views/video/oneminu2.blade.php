...
@endsection
@section('content')
<link type="text/css" rel="stylesheet" href="{{url('/css/videos.css')}}?v=2.0.3" />
<!-- 二级banner -->
...
<div class="content">
    <!-- 一分钟 -->
    <div class="hotlist yfz">
        <h2 class="bTitle">资芽一分钟</h2>
...
<script type="text/javascript">
    $(function(){
        ...
        $.ajax({  
            url: 'http://api.ziyawang.com/v1/video/list?pagecount=16&VideoLabel=zyyfz&access_token=token&startpage=' + urlpage,  
            type: 'GET',  
            dataType: 'json',  
            timeout: 5000, 
            cache: false,  
        ...
        function hhh(tt) {
            ...
            $('.pagination a').click(function(){
                ...
                var url = "http://ziyawang.com/video/oneminu?startpage=" + urlpage;
                url = encodeURI(url);
