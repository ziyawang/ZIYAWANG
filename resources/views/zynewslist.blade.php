...
<!-- 左侧 -->
    <div class="news_left1">
        <div class="news_bread"><a href="{{url('/')}}">首页&gt;</a><span>资芽新闻</span></div>
...
$(function(){
    ...
    //新闻 4个ajax
    $.ajax({  
        url: 'http://api.ziyawang.com/v1/news/list?pagecount=6&NewsLabel=资芽新闻&access_token=token',  
        type: 'GET',  
        dataType: 'json',  
        timeout: 1000,  
        cache: false,  
...
function ajax(){
    ...
    $.ajax({
        url: 'http://api.ziyawang.com/v1/news/list?pagecount=6&NewsLabel=资芽新闻&access_token=token&' + data,  
        type: 'GET',  
        dataType: 'json',  
        timeout: 1000,  
        cache: false,  
