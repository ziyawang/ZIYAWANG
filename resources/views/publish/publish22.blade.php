                ...
                <div class="fore-con">
                    ...
                    <div class="fore-main">
                        <div class="row">
                            ...
                            <p><input type="hidden" name="AssetType" value="汽车"></p>
                        ...
                        <div class="row">
                            <span class="row-left"><em class="must">*</em>品牌型号：</span>
                            <input name="Brand" type="text" class="inps bitian" placeholder="请输入" />
                        </div>
                        <div class="row">
                        ...
                        <div class="row" id="cwts">
                            ...
                            <span class="row-right">
                                <div class="land">
                                    <span class="inp-radio opts"><input name="State" value="一拍" type="radio" class="radios bitian" id="firstPa" /></span>
                                    <label for="firstPa" class="inp-label">一拍</label><em class="wem2"></em>
                                </div>
                                <div class="house">
                                    <span class="inp-radio opts"><input name="State" value="二拍" type="radio" class="radios bitian" id="secondPa" /></span>
                                    <label for="secondPa" class="inp-label">二拍</label><em class="wem2"></em>
                                </div>
                                <div class="car">
                                    <span class="inp-radio opts"><input name="State" value="三拍" type="radio" class="radios bitian" id="thirdPa" /></span>
