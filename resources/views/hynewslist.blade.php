...
$(function(){
    ...
    //新闻 4个ajax
    $.ajax({  
        url: 'http://api.ziyawang.com/v1/news/list?pagecount=6&NewsLabel=行业动态&access_token=token',  
        type: 'GET',  
        dataType: 'json',  
        timeout: 1000,  
        cache: false,  
...
function ajax(){
    ...
    $.ajax({
        url: 'http://api.ziyawang.com/v1/news/list?pagecount=6&NewsLabel=行业动态&access_token=token&' + data,  
        type: 'GET',  
        dataType: 'json',  
        timeout: 1000,  
        cache: false,  
