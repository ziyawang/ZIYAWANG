...
<html lang="en">
    <head>
        ...
        <link type="text/css" rel="stylesheet" href="{{asset('/css/index.css')}}?v=2.1.7.1.1" />
        ...
        <meta name="Description" content="资芽网首期不良资产培训课程涵盖了五大模块，互联网+不良资产模式创新，不良资产行业与投资策略，银行不良资产及资产腾挪互联网平台模式创新，企业债权债务托管，不良资产清收处置办法，全面系统，实战教学案例分享，优秀师资团队，等你报名！" />
        ...
        <script type="text/javascript" src="{{url('/js/public.js')}}?v=2.1.7.1.1"></script>
