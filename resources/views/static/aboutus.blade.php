...
@section('content')
    ...
    <div class="revisionCon clearfix">
        ...
        <div class="ucRight">
            <div class="revisionTitle"><span>关于我们</span></div>
            <div class="revAbout">
                <p class="infoText">资芽（北京）网络科技有限公司座落在北京中关村国际创客中心，旗下资芽网（www.ziyawang.com）于2016年7月31日上线，资芽网吸引全国各类不良资产持有者，汇集各类不良资产信息及相关需求，整合海量相关处置服务机构与投资方，搭建多样化处置通道和不良资产综服生态产业体系，嵌入移动社交与视频直播，兼具媒体属性，实现大数据搜索引擎和人工智能，打造共享开放的全球不良资产超级综服平台。</p>
            </div>
        </div>
    </div>
@endsection