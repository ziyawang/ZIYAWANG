...
@section('seo')
<title>财经资讯_新闻中心_全球不良资产超级综服平台-资芽网</title>
...
<!-- 左侧 -->
    <div class="conLeft">
        <div class="news_bread"><span class="newsIcon financial"></span>财经资讯</div>
...
$(function(){
    ...
    //新闻 4个ajax
    $.ajax({  
        url: 'http://api.ziyawang.com/v1/news/list?pagecount=6&NewsLabel=cjzx&access_token=token&startpage=' + urlpage,  
        type: 'GET',  
        dataType: 'json',  
        timeout: 5000,  
        cache: false,  
    ...
    function news(tt) {
        ...
        $('.pagination a').click(function(){
            ...
            var url = "http://ziyawang.com/cjnews?startpage=" + urlpage;
            url = encodeURI(url);
