...
@section('seo')
<title>资芽新闻_新闻中心_全球不良资产超级综服平台-资芽网</title>
...
$(function(){
    ...
    //新闻 4个ajax
    $.ajax({  
        url: 'http://apis.ziyawang.com/zll/news/list?pagecount=6&NewsLabel=zyxw&access_token=token&startpage=' + urlpage,  
        type: 'GET',  
        dataType: 'json',  
        timeout: 5000,  
        cache: false,  
    ...
    $.ajax({  
        url: 'http://apis.ziyawang.com/zll/news/list?pagecount=5&NewsLabel=cjzx&access_token=token',  
        type: 'GET',  
        dataType: 'json',  
        timeout: 5000,  
        cache: false,  
