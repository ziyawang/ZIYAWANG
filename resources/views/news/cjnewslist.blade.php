...
$(function(){
    ...
    //新闻 4个ajax
    $.ajax({  
        url: 'http://api.ziyawang.com/v1/news/list?pagecount=6&NewsLabel=cjzx&access_token=token',  
        type: 'GET',  
        dataType: 'json',  
        timeout: 5000,  
        cache: false,  
...
function ajax(){
    ...
    $.ajax({
        url: 'http://api.ziyawang.com/v1/news/list?pagecount=6&NewsLabel=cjzx&access_token=token&' + data,  
        type: 'GET',  
        dataType: 'json',  
        timeout: 5000,  
        cache: false,  
