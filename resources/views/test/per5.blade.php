        ...
        <div class="assess-start clearfix">
            <div class="assess-l">
                ...
                <div class="mixture">
                    <div class="subject" id='P21'>
                        ...
                        <div class="opts">
                            ...
                            <div class="item">
                                <div class="status" answer="3个月至6个月（不包括6个月）2"><input type="radio" class="radios" id="appoint02" /></div>
                    ...
                    <div class="subject" id='P22'>
                        ...
                        <div class="opts">
                            <div class="item">
                                <div class="status" answer="未催收1"><input type="radio" class="radios" id="call01" /></div>
                            ...
                            <div class="item">
                                <div class="status" answer="催收，次数5次至10次0"><input type="radio" class="radios" id="call03" /></div>
                    ...
                    <div class="subject" id='P23'>
                        ...
                        <div class="opts">
                            <div class="item">
                                <div class="status" answer="未催收1"><input type="radio" class="radios" id="indeed01" /></div>
                    ...
                    <div class="subject" id='P24'>
                        <div class="questions">
                            <span>24、您是否委托他人或律师事务所催收，以及催收的次数：</span>
                        </div>
                        <div class="opts">
                            <div class="item">
                                <div class="status" answer="未催收1"><input type="radio" class="radios" id="urge01" /></div>
                            ...
                            <div class="item">
                                <div class="status" answer="催收，次数2次0"><input type="radio" class="radios" id="urge03" /></div>
                    ...
                    <div class="subject" id='P25'>
                        ...
                        <div class="opts">
                            ...
                            <div class="item">
                                <div class="status" answer="判决已生效，且强制执行中1"><input type="radio" class="radios" id="lawsuit04" /></div>
                ...
                <div class="assess-btn2">
                    <a href="{{url('/test/page').'?type=per&page=4'}}" class="assess-btn">上&nbsp;一&nbsp;页</a>
                    <a href="javascript:;" id="next" class="assess-btn">提&nbsp;交</a>
                </div>
